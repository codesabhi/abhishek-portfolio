  ...
  return(
      <div className="a">
          ...
          <div className="a-right">
            ...
            <span><a style={{color:'teal'}}>▹</a></span> I helped various business owners, and real estate agents to launch their businesses by building their digital presence across the world.<br/><br/>
            
            Fast-forward to today, my main focus these days is optimizing websites' conversion rates & building accessible full-stack IDX tools for realtors.
